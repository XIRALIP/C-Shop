...
public class ItemCotroller {
	...
	@ResponseBody
	public CshopResult createItem(TbItem item,String desc,String itemParams) throws Exception{
		CshopResult result = itemService.createItem(item,desc,itemParams);
		return result;
	}
}
